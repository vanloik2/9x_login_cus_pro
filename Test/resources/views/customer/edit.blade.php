    ...
    <div class="col-md-6">
        ...
        <form action="{{ route('customer.update', $customer->customer_id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Customer Name" name="customer_name" value="{{ $customer->customer_name }}">
            </div>
            <div class="mb-3">
                <label for="contact_name" class="label-control">Contact Name</label>
                <input type="text" class="form-control" placeholder="Contact Name" name="contact_name" value="{{ $customer->contact_name }}">
            </div>
            <div class="mb-3">
